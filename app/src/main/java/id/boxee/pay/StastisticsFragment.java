...
public class StastisticsFragment extends Fragment {


    RecyclerView stastics_recycleview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_stastistics, container, false);

        stastics_recycleview = (RecyclerView)rootView.findViewById(R.id.stastics_recycleview);
        ...
        stastics_recycleview.setLayoutManager(layoutManager1);
        stastics_recycleview.setAdapter(mActivities_Adapter);
